...
jQuery(function(){
  /**
    ...
    /**
     * 
     * Description: Disable button on submit
     * Template: single-gig.php
     */
    jQuery('#attending').submit(function(){
       // jQuery(this).children('button').innerText("Loading...");
    });
     ...
     */
      ...
      jQuery('.js-sort').on('change',function(){
        ...
        switch (option) {
          case "az":
            jQuery('.sort #js-az').trigger('click');
            break;
          case "za":
              jQuery('.sort #js-za').trigger('click');
              break;
          case "1-10":
              jQuery('.sort #js-1-10').trigger('click');
              break;
          case "10-1":
              jQuery('.sort #js-10-1').trigger('click');
              break;
        }
      });
      ...
      jQuery('.videos__item').each(function(i, obj) {
        var src = jQuery(this).find("iframe").attr('src');
        console.log(src);
        jQuery(this).find(".videos__item__link").attr('href', src);
      });
});