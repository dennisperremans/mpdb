                    ...
                    <div class="content-gig">
                        ...
                        <div class="setlist">
                            <div class="setlist__header">
                                <h2 class="setlist__header__title">Setlist <?php if(get_field('hasRecording')) { ?>&nbsp;&nbsp;<i title="Recording available" class="fas fa-music"></i> <?php } ?></h2>
                            ...
                            <div class="block">
                                ...
                                <div class="block__content">
                                    <?php if(get_field('hasRecording')) { ?>
                                        <p>
                                            <i title="Recording available" class="fas fa-music"></i> Recording available
                                        </p>
                                    <?php } ?>
                                    <?php the_content(); ?>
                                </div>
